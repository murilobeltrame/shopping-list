# ShoppingList Android Constitution

## Core Principles

### I. Native Android Experience First

Features MUST follow Android-native interaction, lifecycle, accessibility, and platform behavior expectations across supported devices.

### II. Contract-First Integration

All backend interactions MUST be based on documented backend contracts. Client-side payload or error assumptions are prohibited unless explicitly specified.

### III. Test-First Development (NON-NEGOTIABLE)

Every feature MUST follow Red-Green-Refactor, with unit coverage for logic and UI or device-level coverage for critical flows when needed.

### IV. Resilient State and Device Awareness

Features MUST define behavior for loading, retry, offline, configuration changes, process death recovery, and device capability constraints.

### V. Accessibility, Performance, and Privacy

Features MUST be accessible, performant on supported devices, and explicit about data collection, local storage, and permission usage.

## Project Structure & Quality Gates

- Source code lives under `src/` or the Android project structure selected in the plan
- Tests live under `test/`
- Specs live under `specs/`
- Plans MUST document chosen UI architecture, navigation approach, and offline strategy
